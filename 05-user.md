...
The developer has chosen Node.js to build this service.

Before installation, we must confirm the required version with the developer. In this case, the application supports Node.js version 20 or higher.

**🔹Installation Requirement**

By default, Node.js 16 is available in the system repositories. However, since the application requires a newer version, we need to install Node.js 20.
...
The User Service application is not provided as an RPM package like other software. So, we need to configure and set up the application manually.
...
The roboshop user is a dedicated system user used to run the application as a service. It is not used for logging into the server.
...
**Enable & Start the User Service using systemctl**
